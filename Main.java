...
public class Main {
	...
	public static void main(String[] args) {
		...
		String st = game.askForText("Do you want to play again");
	
		ch1 = Character.toLowerCase(st.charAt(0));
		while (ch1 != 'y' && ch1 != 'n'){
			st = game.askForText("Invalid answer,please enter either Yes or No");
